...
function preloadTextures() {
    return new Promise(function(resolve, reject){
        sounds.click_no = new Howl({
            src: CONFIG.URL_ASSETS+"/sounds/click_sound_no.mp3"
        });
        sounds.click_error = new Howl({
            src: CONFIG.URL_ASSETS +"/sounds/click_sound_error.mp3"
        });
        sounds.click_cell = new Howl({
            src: CONFIG.URL_ASSETS+"/sounds/click_sound_cell.mp3"
        });
        sounds.click_flag = new Howl({
            src: CONFIG.URL_ASSETS +"/sounds/click_sound_flag.mp3"
        });
        sounds.explosion = new Howl({
            src: CONFIG.URL_ASSETS +"/sounds/explosion.mp3"
        });
        resolve();
    });
}